...
sortAffiliations=function(file, n, GNout, GSout, dir="bibs"){
  ...
  aff$aff[grep(pattern = "USA", x = aff$aff)]="USA"
  aff$aff[aff$aff=="USA"]="United States"
  
  aff$aff[grep(pattern = "China", x = aff$aff)]="China"
